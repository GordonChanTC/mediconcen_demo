drop database if exists mediconcen_demo;
...
(
    MEDICATION_UNIT_ID  BIGINT AUTO_INCREMENT,
    UNIT                VARCHAR(4),
    PRIMARY KEY (MEDICATION_UNIT_ID)
);
...
(
    ...
    FOREIGN KEY (MEDICATION_UNIT_ID) REFERENCES MEDICATION_UNIT(MEDICATION_UNIT_ID)
);
